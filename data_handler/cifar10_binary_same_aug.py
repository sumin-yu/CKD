...
class CIFAR_10S_binary_same_aug(CIFAR_10S_binary_same):
    def __init__(self, root, split='train', transform=None,
        ...
        super(CIFAR_10S_binary_same_aug, self).__init__(root, split=split, transform=transform, seed=seed, skewed_ratio=skewed_ratio, domain_gap_degree=domain_gap_degree, editing_bias_alpha=editing_bias_alpha, editing_bias_beta=editing_bias_beta, noise_degree=noise_degree, noise_type=noise_type)
